...
-- 3) handle_new_user — create profile + link existing tg row if matched by email
...
-- 4) is_owner helper — works for both email and telegram identities
...
-- 5) replace RLS policies on user-owned tables
